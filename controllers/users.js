...
usersRouter.post('/' , async (request, response) => {
  ...
  await transporter.sendMail({
    ...
    text: 'Te hemos enviado un correo para validar tu registro', // plain text body
...
usersRouter.patch('/:id/:token' , async (request, response) => {
  try {
    ...
    await transporter.sendMail({
      ...
      subject: 'Verificacion de usuario ✔', // Subject line
      text: 'Te hemos enviado un correo para validar tu registro', // plain text body
      html: `<a class="bg-green-600" href="${PAGE_URL}/verify/${id}/${token}">Verificar correo</a>`, // html body
    });
